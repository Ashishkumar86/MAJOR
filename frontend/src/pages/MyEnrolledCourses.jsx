...
function MyEnrolledCourses() {
    ...
    return (
        <div className='min-h-screen w-full px-4 py-9 bg-gray-50'>
            ...
            {userData?.enrolledCourses?.length === 0 || !userData?.enrolledCourses ? (
                ...
                <div className='flex items-center justify-center flex-wrap gap-[30px]'>
                    {userData.enrolledCourses.map((course) => (
                        <div key={course._id} className='w-[280px] bg-white rounded-2xl shadow-md overflow-hidden border'>
                            <img
                            ...
                            <div className='p-4'>
                                ...
                                <button
                                    className='w-full px-[10px] text-center py-[10px] border-2 bg-[#5A4BDA] border-white text-white rounded-[10px] text-[15px] font-light cursor-pointer mt-[10px] hover:bg-gray-600'
