       ...
       <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center'>
           <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex' onSubmit={(e)=>e.preventDefault()}>
               ...
               <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3'>
                   ...
                   <button className='w-[80%] h-[40px] bg-[#5A4BDA] text-white cursor-pointer flex items-center justify-center rounded-[5px] cursor-pointer' disabled={loading} onClick={handleLogin}>{loading ? <ClipLoader size={30} color="white"/>:
                    "Login"}
                   </button>
                   ...
                   <div className='w-[80%] flex items-center gap-2'>
                    ...
                    <button
                        type = "button"
                    className='w-[80%] h-[40px] border-2 border-[#5A4BDA] rounded-[5px] flex items-center justify-center' onClick={googleLogin}>
